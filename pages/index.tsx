...
className={index?'absolute border md:mb-2  border-[#F7AB0A]/40 rounded-lg mx-[1.3%] bg-gray-900 right-0 left-0 md:left-[85%] md:p-2  md:pr-2 flex flex-row md:flex-col justify-center md:right-5 items-end':'hidden'}>
      <Link href='#home'> 
